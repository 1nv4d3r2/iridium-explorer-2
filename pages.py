...
# Iridium Explorer 2 (c) Iridium Developer 2023
...
<body>
    ...
    <p style="font-size: smaller">
        <span style="font-style: italic">
            Powered by <a href="https://github.com/Iridium/iridium-explorer-2">Iridium Explorer 2</a>
        </span>
    </p>
    </div>
</body>
...
#            print(refresh_script)
    ...
    def handle_chains(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer"
        tvars['h1']="Iridium Explorer"
...
# List of divs to be updated and elements of the path which should retreive data for this div
    ...
    def handle_chain(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name']
...
#        body += '<div id="publishers">' + DEFAULT_LOADING_HTML + '</div>'
        ...
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + title
...
# List of divs to be updated and elements of the path which should retreive data for this div
    ...
    def handle_assetissues(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + entity_name + " - asset issues"
    ...
    def handle_addressstreams(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + str(params[0]) + " - address streams"
    ...
    def handle_addressassets(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + str(params[0]) + " - address assets"
    ...
    def handle_addresstransactions(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + str(params[0]) + " - address transactions"
    ...
    def handle_blocktransactions(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - block " + str(params[0]) + " - transactions"
    ...
    def handle_assettransactions(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + entity_name + " - asset transactions"
    ...
    def handle_assetholders(self,chain,params,nparams):
        ...
        if entity_quoted != DEFAULT_NATIVE_CURRENCY_ID:
            tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + entity_name + " - asset holders"
            ...
            tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - Native Currency holders"
    ...
    def handle_assetholdertransactions(self,chain,params,nparams):
        ...
        tvars['body']=body          
        if entity_quoted != DEFAULT_NATIVE_CURRENCY_ID:
            tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + str(params[1]) + " - transactions for asset " + entity_name
            ...
            tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + str(params[1]) + " - Native Currency transactions"
    ...
    def handle_globalpermissions(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - global permissions"
    ...
    def handle_assetpermissions(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + entity_name + " - asset permissions"
    ...
    def handle_streampermissions(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + entity_name + " - stream permissions"
    ...
    def handle_streamitems(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + entity_name+ " - stream items"
    ...
    def handle_streamkeys(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + entity_name + " - stream keys"
    ...
    def handle_streampublishers(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + entity_name + " - stream publishers"
    ...
    def handle_keyitems(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + entity_name + " - items for key " + parse.unquote_plus(str(params[1]))
    ...
    def handle_publisheritems(self,chain,params,nparams):
        ...
        tvars['body']=body          
        tvars['title']="Iridium Explorer - " + chain.config['display-name'] + " - " + entity_name + " - items published by " + str(params[1])
...
# List of divs to be updated and elements of the path which should retreive data for this div
    ...
    def handle_notfound(self,chain=None,params=None,nparams=None):
        ...
        if chain is None:
            tvars['title']="Iridium Explorer" + title
