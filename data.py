...
# Iridium Explorer 2 (c) Coin Sciences Ltd
...
def tags_to_labels(tags):
    ...
    for tag in tags:
        ...
        if tag not in TAG_TO_LABEL_TEXT:
            ...
            labels.append((this_label_type,"Unknown Iridium Command"))
            take_it=False
        else:
...
#        body += '</table>'
    ...
    def handle_addresses(self,chain,params,nparams):
        ...
        if last is None:
            return self.standard_response('<div class="alert alert-danger" role="alert">Explorer APIs are not enabled. To enable them, please run "iridiumd -explorersupport=1 -rescan"</div>')
...
#                body += '<td><span class="label label-warning">Not Local</span></td>'                                        
    ...
    def handle_assetissues(self,chain,params,nparams):
        ...
        if 'issuecount' not in response['result'][0]:
            return self.standard_response('<div class="alert alert-danger" role="warning">Not supported in this version of Iridium</div>')
